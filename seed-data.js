(function(root,factory){
  ...
  const roundGames=[
    ...
    {id:"sharks-sea-eagles",title:"Sharks vs Sea Eagles",homeTeam:"Sharks",awayTeam:"Sea Eagles",venue:"Sharks Stadium",roundLabel:"Round 5",kickoff:"Thu 2 Apr 8:00 PM",kickoffAt:"2026-04-02T20:00:00+11:00"},
    {id:"panthers-cowboys",title:"Panthers vs Cowboys",homeTeam:"Panthers",awayTeam:"Cowboys",venue:"BlueBet Stadium",roundLabel:"Round 5",kickoff:"Fri 3 Apr 6:00 PM",kickoffAt:"2026-04-03T18:00:00+11:00"},
    {id:"storm-warriors",title:"Storm vs Warriors",homeTeam:"Storm",awayTeam:"Warriors",venue:"AAMI Park",roundLabel:"Round 5",kickoff:"Fri 3 Apr 8:00 PM",kickoffAt:"2026-04-03T20:00:00+11:00"},
    {id:"roosters-broncos",title:"Roosters vs Broncos",homeTeam:"Roosters",awayTeam:"Broncos",venue:"Allianz Stadium",roundLabel:"Round 5",kickoff:"Sat 4 Apr 3:00 PM",kickoffAt:"2026-04-04T15:00:00+11:00"},
    {id:"eels-raiders",title:"Eels vs Raiders",homeTeam:"Eels",awayTeam:"Raiders",venue:"CommBank Stadium",roundLabel:"Round 5",kickoff:"Sat 4 Apr 5:30 PM",kickoffAt:"2026-04-04T17:30:00+11:00"},
    {id:"bulldogs-titans",title:"Bulldogs vs Titans",homeTeam:"Bulldogs",awayTeam:"Titans",venue:"Accor Stadium",roundLabel:"Round 5",kickoff:"Sat 4 Apr 7:35 PM",kickoffAt:"2026-04-04T19:35:00+11:00"},
    {id:"knights-rabbitohs",title:"Knights vs Rabbitohs",homeTeam:"Knights",awayTeam:"Rabbitohs",venue:"McDonald Jones Stadium",roundLabel:"Round 5",kickoff:"Sun 5 Apr 4:05 PM",kickoffAt:"2026-04-05T16:05:00+10:00"},
    {id:"dolphins-dragons",title:"Dolphins vs Dragons",homeTeam:"Dolphins",awayTeam:"Dragons",venue:"Suncorp Stadium",roundLabel:"Round 5",kickoff:"Sun 5 Apr 6:15 PM",kickoffAt:"2026-04-05T18:15:00+10:00"}
  ];
  const matchOddsByGame={"raiders-bulldogs":{home:1.9,away:1.9},"roosters-panthers":{home:1.9,away:1.9},"storm-broncos":{home:1.9,away:1.9},"knights-warriors":{home:1.9,away:1.9},"sharks-dolphins":{home:1.9,away:1.9},"rabbitohs-wests-tigers":{home:1.9,away:1.9},"eels-dragons":{home:1.9,away:1.9},"cowboys-titans":{home:1.9,away:1.9},"sea-eagles-roosters":{home:1.9,away:1.9},"warriors-wests-tigers":{home:1.9,away:1.9},"broncos-dolphins":{home:1.9,away:1.9},"bulldogs-knights":{home:1.9,away:1.9},"cowboys-storm":{home:1.9,away:1.9},"eels-panthers":{home:1.9,away:1.9},"raiders-sharks":{home:1.9,away:1.9},"titans-dragons":{home:1.9,away:1.9},"sharks-sea-eagles":{home:1.9,away:1.9},"panthers-cowboys":{home:1.9,away:1.9},"storm-warriors":{home:1.9,away:1.9},"roosters-broncos":{home:1.9,away:1.9},"eels-raiders":{home:1.9,away:1.9},"bulldogs-titans":{home:1.9,away:1.9},"knights-rabbitohs":{home:1.9,away:1.9},"dolphins-dragons":{home:1.9,away:1.9}}; // Demo odds seed. Replace these with your actual match prices.
  ...
  playerRowsByGame["sharks-sea-eagles"]=[...cloneTeamRows("raiders-sharks","Sharks"),...cloneTeamRows("sea-eagles-roosters","Sea Eagles")];
  playerRowsByGame["panthers-cowboys"]=[...cloneTeamRows("eels-panthers","Panthers"),...cloneTeamRows("cowboys-storm","Cowboys")];
  playerRowsByGame["storm-warriors"]=[...cloneTeamRows("cowboys-storm","Storm"),...cloneTeamRows("warriors-wests-tigers","Warriors")];
  playerRowsByGame["roosters-broncos"]=[...cloneTeamRows("sea-eagles-roosters","Roosters"),...cloneTeamRows("broncos-dolphins","Broncos")];
  playerRowsByGame["eels-raiders"]=[...cloneTeamRows("eels-panthers","Eels"),...cloneTeamRows("raiders-sharks","Raiders")];
  playerRowsByGame["bulldogs-titans"]=[...cloneTeamRows("bulldogs-knights","Bulldogs"),...cloneTeamRows("titans-dragons","Titans")];
  playerRowsByGame["knights-rabbitohs"]=[...cloneTeamRows("bulldogs-knights","Knights"),...cloneTeamRows("rabbitohs-wests-tigers","Rabbitohs")];
  playerRowsByGame["dolphins-dragons"]=[...cloneTeamRows("broncos-dolphins","Dolphins"),...cloneTeamRows("titans-dragons","Dragons")];
